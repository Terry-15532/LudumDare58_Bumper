...
public class CustomButton : CustomUIElement, IAsButton {
    ...
    public CustomButton Create(string str = null) {
        if (str != null) {
            var button = (CustomButton)Tools.Create("LWButton");
            try {
        ...
        else return (CustomButton)Tools.Create("LWButton");
    }
